...
<head>
    ...
    <link rel="stylesheet" href="assetsPublic/core.min.css?v=2">
    <link rel="stylesheet" href="public/assets/eventos.css?v=2">
    <link rel="stylesheet" href="assetsPublic/fonts.min.css?v=2">
...
<body>
<div id="app">
    <section class="core-class-container r-panel r-index"
             style="position: relative; top: initial; width: 100%; left: initial; overflow: hidden; opacity: 1;"
             data-file="index" id="core-content">
        <div class="col">
            ...
            <h1 class="titleVertical">destaques</h1>
            <div class="col" id="destaque-parent">
                <div class="col padding-32" id="destaque"></div>
            </div>
            <h1 class="titleVertical todos">todos</h1>
            <div class="col" id="home-parent">
                <div class="col padding-32" id="home"></div>
            </div>
        </div>
